package com.example.giaccomo.securityconnexion;
...
public class MainActivity extends AppCompatActivity implements
    ...
    // Note: Your consumer key and secret should be obfuscated inyour source code before shipping.
    private static final String TWITTER_KEY = "MvBVr9lKtt7hU9u1yw7LBfGKU";
    private static final String TWITTER_SECRET = "dfkN59aUK9myhZCJxhPVfzVurKgfanzSy3rsPAFI0NXN1RKpVs";
    //Tags to send the username and image url to next activityusing intent
